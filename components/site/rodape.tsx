...
export function Rodape() {
  return (
    <footer className="bg-mata text-branco">
      <div className="@container mx-auto max-w-[1400px] px-5 py-16 sm:px-8">
        ...
        <div className="mt-14 grid gap-10 border-t border-white/15 pt-10 sm:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-white/70">
              {CIDADE} — parques, orla e serra, quatro provas por temporada.
            </p>
          </div>
